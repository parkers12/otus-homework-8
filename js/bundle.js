...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"launchSlider\": function() { return /* binding */ launchSlider; }\n/* harmony export */ });\n/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./functions */ \"./src/js/slider/functions.js\");\n/* harmony import */ var _errorMessage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./errorMessage */ \"./src/js/slider/errorMessage.js\");\n\n\nfunction launchSlider(bullit, isBack, items) {\n  var actNum = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getNumberActive)(items);\n\n  if (actNum >= 0) {\n    if (isBack) {\n      (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getPrevSlide)(actNum, items, bullit, \"\");\n    } else {\n      (0,_functions__WEBPACK_IMPORTED_MODULE_0__.getNextSlide)(actNum, items, bullit, \"\");\n    }\n  } else {\n    (0,_errorMessage__WEBPACK_IMPORTED_MODULE_1__.errorMessage)(\"Error: without active slide\");\n  }\n}\n\n//# sourceURL=webpack://otus-homework-8/./src/js/slider/launcher.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"starterSlider\": function() { return /* binding */ starterSlider; },\n/* harmony export */   \"sliderJS\": function() { return /* binding */ sliderJS; }\n/* harmony export */ });\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./config */ \"./src/js/slider/config.js\");\n/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions */ \"./src/js/slider/functions.js\");\n/* harmony import */ var _launcher__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./launcher */ \"./src/js/slider/launcher.js\");\n/* harmony import */ var _handlers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./handlers */ \"./src/js/slider/handlers.js\");\n/* harmony import */ var _errorMessage__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./errorMessage */ \"./src/js/slider/errorMessage.js\");\n\n\n\n\n\nvar launcher;\nfunction starterSlider(bullit, isBack, itemsSl, loop) {\n  if (loop) {\n    launcher = setTimeout(_launcher__WEBPACK_IMPORTED_MODULE_2__.launchSlider, _config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].slideChangeInterval, bullit, isBack, itemsSl);\n  } else {\n    (0,_launcher__WEBPACK_IMPORTED_MODULE_2__.launchSlider)(bullit, isBack, itemsSl);\n  }\n}\nfunction sliderJS() {\n  var slider = document.getElementById(_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].sliderId);\n  var items = (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getArraySlides)(slider);\n  var sliderBullit = \"\";\n\n  if (slider !== null && items.length > 0) {\n    (0,_functions__WEBPACK_IMPORTED_MODULE_1__.addFirstSldActive)(items[0]);\n\n    if (items.length > 1) {\n      if (_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].isBullit) {\n        (0,_functions__WEBPACK_IMPORTED_MODULE_1__.getBullitList)(items.length, slider);\n        sliderBullit = document.getElementById(_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].sliderBullit);\n        starterSlider(sliderBullit, false, items, true);\n      } else {\n        starterSlider(false, false, items, true);\n      }\n    }\n  } else {\n    var mes = \"The slider ID was not found on the \" + \"page or the list of images is missing\";\n    (0,_errorMessage__WEBPACK_IMPORTED_MODULE_4__.errorMessage)(mes);\n  }\n\n  var arrows = document.getElementById(\"arrows\");\n\n  if (arrows) {\n    arrows.addEventListener(\"click\", function (e) {\n      clearTimeout(launcher);\n      var pauseBtn = document.getElementById(_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].pauseSlider);\n      pauseBtn.classList.add(_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].stopSlider);\n      var arrButton = (0,_handlers__WEBPACK_IMPORTED_MODULE_3__.arrowHandler)(e);\n\n      if (arrButton === _config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].arrowsLeft) {\n        starterSlider(sliderBullit, true, items, false);\n      } else if (arrButton === _config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].arrowsRight) {\n        starterSlider(sliderBullit, false, items, false);\n      } else if (arrButton === _config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].pauseSlider) {\n        starterSlider(sliderBullit, false, items, true);\n      }\n    });\n  } else {\n    (0,_errorMessage__WEBPACK_IMPORTED_MODULE_4__.errorMessage)(\"Error: without arrow button\");\n  }\n\n  var bullitList = document.getElementById(\"sliderBullit\");\n\n  if (bullitList) {\n    bullitList.addEventListener(\"click\", function (e) {\n      var pauseBtn = document.getElementById(_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].pauseSlider);\n      pauseBtn.classList.add(_config__WEBPACK_IMPORTED_MODULE_0__[\"default\"].stopSlider);\n      clearTimeout(launcher);\n      (0,_handlers__WEBPACK_IMPORTED_MODULE_3__.bullitHandler)(e, items);\n    });\n  } else {\n    (0,_errorMessage__WEBPACK_IMPORTED_MODULE_4__.errorMessage)(\"Error: without bullit buttons\");\n  }\n}\n\n//# sourceURL=webpack://otus-homework-8/./src/js/slider/slider.js?");
